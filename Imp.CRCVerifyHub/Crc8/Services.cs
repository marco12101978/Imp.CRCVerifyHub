...
namespace Imp.CRCVerifyHub.Crc8
{
    /// <summary>
    ...
    {
        private static readonly byte[] Table = { 0x00, 0xD5, 0x7F, 0xAA, 0xFE, 0x2B, 0x81, 0x54, 0x29, 0xFC, 0x56, 0x83, 0xD7, 0x02, 0xA8, 0x7D,
        ...
        private static byte InitialValue = 0;
        // <summary>
        ...
        public static byte crcChecksumGenerator(params byte[] bytes)
        {
        ...
        /// <returns>O CRC especificado</returns>
        public static byte crcChecksumGenerator(byte[] bytes, int start, int length)
        {
            ...
            if (bytes == null || bytes.Length == 0)
                throw new ArgumentException("Invalid input bytes");
