...
namespace Imp.CRCVerifyHub.Crc16
{
    ...
    /// <summary>
    /// Classe utilitária para cálculo do CRC 16 CCITT usando o polinômio x^16 + x^12 + x^5 + 1 com um valor CRC inicial de 0xFFFF.
    /// </summary>
    internal static class Ccitt_Initial_0XFfff
    {
        private const ushort LocalInitialValue = ushort.MaxValue;

        /// <summary>
        /// Calcula o CRC 16 CCITT dos bytes fornecidos usando um valor inicial de 0xFFFF.
        /// </summary>
        ...
        {
            return Ccitt_Base.Checksum(LocalInitialValue, bytes);
        }
        ...
        {
            return Ccitt_Base.Checksum(LocalInitialValue, bytes, start, length);
        }
    }
}
