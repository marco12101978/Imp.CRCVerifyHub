...
{
    /// <summary>
    /// Classe utilitária para cálculo de CRC 16 CCITT usando o polinômio x^16 + x^12 + x^5 + 1
    /// com um valor CRC inicial de 0x1D0F.
    /// </summary>
    internal static class Ccitt_Initial_0X1D0F
    {
        private const ushort InitialValue = 0x1D0F;

        /// <summary>
        /// Calcula o CRC 16 CCITT dos bytes fornecidos usando o valor inicial de 0x1D0F.
        /// </summary>
        ...
        {
            return Ccitt_Base.Checksum(InitialValue, bytes);
        }

        /// <summary>
        /// Calcula o CRC 16 CCITT dos bytes fornecidos usando um valor inicial de 0x1D0F.
        /// </summary>
        ...
        {
            return Ccitt_Base.Checksum(InitialValue, bytes, start, length);
        }
    }
}
