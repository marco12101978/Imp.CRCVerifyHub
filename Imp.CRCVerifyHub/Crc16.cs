...
namespace Imp.CRCVerifyHub
{
    ...
    {
        /// <summary>
        /// CRC 16 usando o polinômio invertido x^16 + x^15 + x^2 + 1 (0xA001) com um valor CRC inicial de 0
        /// </summary>
        internal static class StandardCrc16Impl
        {
            // Tabela pré-calculada usando polinômio invertido x^16 + x^15 + x^2 + 1 / 0xA001
            ...
            /// <summary>
            /// Calcula um CRC 16 dos bytes fornecidos
            /// </summary>
            /// <param name="bytes">bytes para CRC</param>
            /// <returns>O CRC 16 dos bytes fornecidos</returns>
        ...
        /// <summary>
        /// CRC 16 para Protocolo de Rede Distribuída (DNP) usando o polinômio invertido x^16 + x^13 + x^12 + x^11 + x^10 + x^8 + x^6 + x^5 + x^2 + 1 (0xA6BC) com um valor CRC inicial de 0
        /// </summary>
        internal static class DnpCrc16Impl
        {
            // Tabela pré-calculada usando polinômio invertido x^16 + x^13 + x^12 + x^11 + x^10 + x^8 + x^6 + x^5 + x^2 + 1 / 0xA6BC
            ...
            /// <summary>
            /// Calcula CRC 16 para Protocolo de Rede Distribuída (DNP) usando o polinômio invertido x^16 + x^13 + x^12 + x^11 + x^10 + x^8 + x^6 + x^5 + x^2 + 1 (0xA6BC) com um valor CRC inicial de 0
            /// </summary>
            /// <param name="bytes">bytes para CRC</param>
            /// <returns>O CRC 16 dos bytes fornecidos</returns>
            internal static ushort ComputeChecksumInternal(params byte[] bytes)
        ...
        /// <summary>
        /// Uma Utilidade CRC 16 CCITT usando um polinômio invertido x^16 + x^12 + x^8 + 1 (0x8408) com um valor CRC inicial de 0
        /// </summary>
        internal static class Crc16CcittKermitImpl
        {
            // Tabela pré-calculada usando polinômio invertido x^16 + x^12 + x^8 + 1 / 0x8408
            ...
            /// <summary>
            /// Calcula um CRC 16 CCITT Kermit dos bytes fornecidos usando um valor inicial de 0
            /// </summary>
        ...
        /// <summary>
        /// Uma Utilidade CRC 16 CCITT usando o polinômio x^16 + x^12 + x^5 + 1 com um valor CRC inicial de 0
        /// </summary>
        internal static class Crc16CcittInitialZeroImpl
        {
            private const ushort LocalInitialValue = ushort.MinValue;
            /// <summary>
            /// Calcula um CRC 16 CCITT dos bytes fornecidos usando um valor inicial de 0
            /// </summary>
            /// <param name="bytes">Bytes para calcular o CRC</param>
            /// <returns>O CRC 16 CCITT dos bytes fornecidos</returns>
        ...
        /// <summary>
        /// Uma utilidade CRC 16 CCITT usando o polinômio x^16 + x^12 + x^5 + 1 com um valor CRC inicial de 0xFFFF
        /// </summary>
        internal static class Crc16CcittInitial0XFfffImpl
        {
            private const ushort LocalInitialValue = ushort.MaxValue;
            /// <summary>
            /// Calcula um CRC 16 CCITT dos bytes fornecidos usando um valor inicial de 0xFFFF
            /// </summary>
            /// <param name="bytes">Bytes para calcular o CRC</param>
            /// <returns>O CRC 16 CCITT dos bytes fornecidos</returns>
            public static ushort ComputeChecksumInternal(params byte[] bytes)
        ...
        /// <summary>
        /// Um utilitario CRC 16 CCITT usando o polinômio x^16 + x^12 + x^5 + 1 com um valor CRC inicial de 0x1D0F
        /// </summary>
        internal static class Crc16CcittInitial0X1D0FImpl
        {
            private const ushort LocalInitialValue = 0x1D0F;
            /// <summary>
            /// Calcula um CRC 16 CCITT dos bytes fornecidos usando um valor inicial de 0x1D0F
            /// </summary>
            /// <param name="bytes">Bytes para calcular o CRC</param>
            /// <returns>O CRC 16 CCITT dos bytes fornecidos</returns>
            public static ushort ComputeChecksumInternal(params byte[] bytes)
        ...
        // Implementação Base do CRC 16 CCITT
        internal static class Crc16CcittBaseImpl
        {
            // Tabela pré-calculada usando o polinômio x^16 + x^12 + x^5 + 1 / 0x1021
            ...
            // Código base para calcular o checksum
