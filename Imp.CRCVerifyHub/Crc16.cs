...
namespace Imp.CRCVerifyHub
{
    public static class Crc16
    {
        ...
        /// <summary>
        /// A CRC 16 CCITT Utility using x^16 + x^12 + x^5 + 1 polynomial with an initial CRC value of 0
        /// </summary>
        ...
        /// <summary>
        /// A CRC 16 CCITT Utility using x^16 + x^12 + x^5 + 1 polynomial with an initial CRC value of 0xFFFF
        /// </summary>
        ...
        /// <summary>
        /// A CRC 16 CCITT Utility using x^16 + x^12 + x^5 + 1 polynomial with an initial CRC value of 0x1D0F
        /// </summary>
